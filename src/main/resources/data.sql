...
VALUES ('Fornecedor A', '12345678901234', 'Contato a', 'fornecedora@email.com', 'Venda de produtos eletrônicos', 1),
       ('Fornecedor B', '56789012345678','Contato b' ,'fornecedorb@email.com', 'Distribuição de alimentos', 2),
       ('Fornecedor C', '90123456789012','Contato c', 'fornecedorc@email.com', 'Serviços de consultoria', 3);
