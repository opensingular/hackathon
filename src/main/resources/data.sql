...
VALUES ('Fornecedor A', 'casas bahia', '12345678901234', 'fornecedora@email.com', 'Venda de produtos eletrônicos', 1),
       ('Fornecedor B', 'magazine luiza','56789012345678', 'fornecedorb@email.com', 'Distribuição de alimentos', 2),
       ('Fornecedor C', 'ricardo eletro','90123456789012', 'fornecedorc@email.com', 'Serviços de consultoria', 3);
